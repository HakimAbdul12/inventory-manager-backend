...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $carsFields = [
            ...
            [
                'key' => 'isOneTimePaymentAvailable',
                'label' => 'One-time Payment Available',
                'type' => 'boolean',
                'required' => false,
                'default' => true,
                'description' => 'Whether the vehicle can be purchased as a one-time payment',
            ],
            [
                'key' => 'isNegotiable',
                'label' => 'Negotiable',
            ...
            [
                'key' => 'isLeaseAvailable',
                'label' => 'Lease Available',
                'type' => 'boolean',
                'required' => false,
                'default' => false,
                'description' => 'Whether lease options are available',
            ],
            [
                'key' => 'leaseMonthsRemaining',
                'label' => 'Lease Months Remaining',
                'type' => 'number',
                'required' => false,
                'min' => 0,
                'description' => 'Months remaining on the lease (if applicable)',
            ],
            [
                'key' => 'leaseTerms',
                'label' => 'Lease Terms',
                'type' => 'array',
                'required' => false,
                'description' => 'List of lease conditions and terms',
            ],
            [
                'key' => 'isFinancingAvailable',
            ...
            [
                ...
                'type' => 'text',
                'required' => false,
                'description' => 'Details about financing options and terms',
            ],
        ];
